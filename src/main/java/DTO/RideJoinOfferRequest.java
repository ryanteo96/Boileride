 ...
 *
 * DTO for ride join offer request
 *
 * @version October 3, 2018
 */

public class RideJoinOfferRequest {
    private int userid;
    private int[] offeridlist;
    private int passenger;
    private int luggage;

    public RideJoinOfferRequest(int userid, int[] offeridlist, int passenger, int luggage) {
        this.userid = userid;
